export async function type(node: HTMLElement, ...args: any[]) {
...
async function edit(node: HTMLElement, text: any) {
...
async function perform(node: HTMLElement, edits: any, speed = 5) {
